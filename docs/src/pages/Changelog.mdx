...
- Use of the [vertex-center/uuid](github.com/vertex-center/uuid) library for better UUID documentation in the OpenAPI specs.
...
:::warning
This release introduces breaking changes. Please proceed with a backup of your volumes and data before updating.
:::
...
- APIs are now documented at [Vertex Docs](https://docs.vertex.arra.red/) `beta`.

### Changed

- The baselines are moved to https://bl.vx.arra.red/
